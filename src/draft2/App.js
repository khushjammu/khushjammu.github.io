...
/*
Urgent TODO to make this version less shitty:
- fix the sizing of the left column
- fonts
- make only right column scrollable
*/
      ...
      <div className="Row">
        ...
        <center>
          <div className="Profile">
            <img src={require('./assets/profile.png')} className="Profile-image"/>
          </div>
          <h1>Khush Jammu</h1>
        </center>
        </div>
